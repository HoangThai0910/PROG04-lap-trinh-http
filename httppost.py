...
data = 'ten=hvt&matkhau=hvt&login='
...
request = f"POST /test-socket/ HTTP/1.1\r\n"
...
request += "Origin: https://thaihv15.000webhostapp.com\r\n"
...
request += "Cookie: PHPSESSID=86u5fs9he4hag4nrivii03i38f\r\n"
request += "\r\n"
request += data
